...
//todo: use me in other tests
class _DepSpec extends AnyFlatSpec with Matchers {
/*
  behavior of "apply"
  ...
  it should "create a Dep instance with proper id and needs" in {
    info("map")
    assertDep(
      Set[CatalogTransformation](
        (c: Catalog) => c.put(c.get[Int]("u").map(_ + 1)),
        t
      )
        .foldLeft(new UntypedCatalog: Catalog)((c, t) => t(c))
        .get[Int]("u_M")
    ...
    assertDep(
      Set[CatalogTransformation](
        (c: UntypedCatalog) => c.put(c.get[Int]("u").map(_ + 1).as("t")),
        t
      )
        .foldLeft(new UntypedCatalog)((c, t) => t(c))
        .get[Int]("t")
    ...
    assertDep(
      Set[CatalogTransformation](
        (c: UntypedCatalog) => c.put(c.get[Int]("u").map(_ + 1).map(_ + 1)),
        t
      )
        .foldLeft(new UntypedCatalog)((c, t) => t(c))
        .get[Int]("u_M_M")
    ...
    assertDep(
      Set[CatalogTransformation](
        (c: UntypedCatalog) => c.put(c.get[Int]("u").map(_ + 1).map(_ + 1).as("t")),
        t
      )
        .foldLeft(new UntypedCatalog)((c, t) => t(c))
        .get[Int]("t")
  ...
  it should "create a Dep instance with proper id and needs" in {
    ...
    assertDep(
      Set[CatalogTransformation](
        (c: UntypedCatalog) => c.put(c.get[Int]("u").flatMap(_ => c.get[Int]("u2"))),
        _.put("u2")(2),
        t
      )
        .foldLeft(new UntypedCatalog)((c, t) => t(c))
    ...
    assertDep(
      Set[CatalogTransformation](
        (c: UntypedCatalog) => c.put(c.get[Int]("u").flatMap(_ => c.get[Int]("u2")).as("t")),
        _.put("u2")(2),
        t
      )
        .foldLeft(new UntypedCatalog)((c, t) => t(c))
    ...
    assertDep(
      Set[CatalogTransformation](
        (c: UntypedCatalog) => c.put(c.get[Int]("u").flatMap(_ => c.get[Int]("u2")).flatMap(_ => c.get[Int]("u3"))),
        _.put("u3")(3),
        _.put("u2")(2),
        t
      )
    ...
    assertDep(
      Set[CatalogTransformation](
        (c: UntypedCatalog) => c.put(c.get[Int]("u").flatMap(_ => c.get[Int]("u2")).flatMap(_ => c.get[Int]("u3")).as("t")),
        _.put("u3")(3),
        _.put("u2")(2),
        t
      )
    ...
    assertDep(
      Set[CatalogTransformation](
        (c: UntypedCatalog) => c.put(c.get[Int]("u").flatMap(u => c.get[Int]("u2").map(u2 => u + u2))),
        _.put("u2")(2),
        t
      )
        .foldLeft(new UntypedCatalog)((c, t) => t(c))
    ...
    assertDep(
      Set[CatalogTransformation](
        (c: UntypedCatalog) => c.put(c.get[Int]("u").flatMap(u => c.get[Int]("u2").map(u2 => u + u2)).as("t")),
        _.put("u2")(2),
        t
      )
        .foldLeft(new UntypedCatalog)((c, t) => t(c))
  ...
  it should "create a Dep instance with proper id and needs" in {
    ...
    assertDep(
      Set[CatalogTransformation](
        (c: UntypedCatalog) => c.put(c.get[Int]("a").map2(c.get[Int]("b"))(_ + _)),
        _.put("b")(2),
        _.put("a")(1)
      )
        .foldLeft(new UntypedCatalog)((c, t) => t(c))
    ...
    assertDep(
      Set[CatalogTransformation](
        (c: UntypedCatalog) => c.put(c.get[Int]("a").map2(c.get[Int]("b"))(_ + _).as("t")),
        _.put("b")(2),
        _.put("a")(1)
      )
        .foldLeft(new UntypedCatalog)((c, t) => t(c))
